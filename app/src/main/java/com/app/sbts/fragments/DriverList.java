...
public class DriverList extends Fragment {
    ...
    void createExcel(){
        File filePath = new File(Environment.getExternalStorageDirectory() + "/Download/DriverList.xls");
        HSSFWorkbook hssfWorkbook = new HSSFWorkbook();
        HSSFSheet hssfSheet = hssfWorkbook.createSheet("Driver List");
        ...
        for (Driver driver : driverList){
            ...
            arr.createCell(0).setCellValue(driver.getFull_Name());
            arr.createCell(1).setCellValue(driver.getEmail());
            arr.createCell(2).setCellValue(driver.getMobile_No1());
            arr.createCell(3).setCellValue(driver.getBus_No());
            i++;
        }
