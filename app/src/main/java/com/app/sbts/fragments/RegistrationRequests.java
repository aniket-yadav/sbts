...
public class RegistrationRequests extends Fragment {
    ...
    void createExcel(){
        File filePath = new File(Environment.getExternalStorageDirectory() + "/Download/RegistrationRequests.xls");
        HSSFWorkbook hssfWorkbook = new HSSFWorkbook();
        HSSFSheet hssfSheet = hssfWorkbook.createSheet("Registration Requests List");
        ...
        int i = 1;
        for (Parent parent : requestsList){
