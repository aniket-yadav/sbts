...
import com.app.sbts.databinding.ActivityRegisterAttendeeBinding;
...
public class RegisterAttendee extends AppCompatActivity {
    ...
    ActivityRegisterAttendeeBinding binding;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityRegisterAttendeeBinding.inflate(getLayoutInflater());
    ...
    private void upload() {
        ...
        String registerDriver = getString(R.string.Attendee_Registration_URL);
